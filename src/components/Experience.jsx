  ...
  const experiences = [
    {
      ...
      logo: ["/bitget.jpg", "/navyai.jpg", "/axelar.jpg"],
    ...
    },
    {
      ...
      logo: ["/unusual.svg", "/astro.jpg", "/xircus.jpg"],
    ...
    },
    {
      ...
      logo: ["/autonomint.jpg", "/iq.jpg", "/iq.jpg"],
    ...
    },
    {
      ...
      logo: ["/sbp.jpg", "/unusual.svg", "/alkimi.jpg"],
                ...
                <div className="space-y-4">
                  <div className="flex flex-wrap gap-3">
                    {exp.companies.map((company, idx) => (
                      <div
                        key={idx}
                        className="flex items-center gap-2 bg-gray-400 p-2 rounded-full transition-all duration-300 hover:scale-105 hover:shadow-md"
                      >
                        <img
                          src={exp.logo[idx]}
                          alt={company}
